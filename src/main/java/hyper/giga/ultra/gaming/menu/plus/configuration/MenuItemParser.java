...
public class MenuItemParser
{
    public static MenuItem parse(JsonObject itemObject)
    {
        ...
        switch (typeString) {
            ...
            case "exit" -> {
                return ExitMenuItemParser.parse(itemObject, backgrounds[0], backgrounds[1], sounds[0], sounds[1]);
            }
            case "switch_screen" -> {
                return SwitchScreenMenuItemParser.parse(itemObject, backgrounds[0], backgrounds[1], sounds[0], sounds[1]);
            }
        }
