...
public class LauncherMenuItem extends ImageWithTextMenuItem
{
    ...
    public LauncherMenuItem(CoolBackground backgroundNormal, CoolBackground backgroundSelected, CoolImage image, Alignment imageAlignment, int imageOffsetX, int imageOffsetY, CoolText text, Alignment textAlignment, int textOffsetX, int textOffsetY, String[] arguments, String workingDirectory, boolean closeOnLaunch)
    {
